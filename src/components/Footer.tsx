        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2">
              <span className="w-8 h-8 rounded-lg bg-gradient-to-tr from-purple-600 to-amber-500 flex items-center justify-center text-white font-extrabold shadow-md">
                Q
              </span>
              <span className="text-lg font-bold font-display tracking-tight bg-gradient-to-r from-purple-600 to-amber-500 bg-clip-text text-transparent">
                TheHalicQuotes
              </span>
            </Link>
