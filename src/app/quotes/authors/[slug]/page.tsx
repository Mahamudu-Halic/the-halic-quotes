...
import { 
  Heart, Copy, Download, User, BookOpen, Sparkles, 
  ChevronLeft, Award, ArrowLeft, RefreshCw, CheckCircle2 
} from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-purple-600 to-indigo-600 text-white flex items-center justify-center border-4 border-purple-500/20 shadow-lg shrink-0">
