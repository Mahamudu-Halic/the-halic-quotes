        ...
        <div className="max-w-4xl mx-auto text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {AUTHORS_LIST.map((author, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 text-white flex items-center justify-center border border-purple-500/20 shrink-0 font-bold">
