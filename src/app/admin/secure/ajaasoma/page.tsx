...
import {
  Database, ShieldAlert, Trash2, Plus,
  CheckCircle2, RefreshCw, Lock, Star, TrendingUp
} from 'lucide-react';
...
export default function AdminPage() {
  ...
  return (
    ...
    <main className="grow hero-gradient py-12 px-4 max-w-7xl mx-auto w-full text-center">
