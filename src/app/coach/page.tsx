...
export default function CoachPage() {
  ...
  if (!user || user.role === 'FREE' || user.role === 'GUEST') {
    return (
      ...
      <main className="grow hero-gradient py-16 px-4 flex items-center justify-center">
        <motion.div
  ...
  return (
    ...
    <main className="grow hero-gradient py-8 px-4 flex flex-col items-center">
      <div className="max-w-4xl w-full grow flex flex-col h-[70vh] bg-white/70 dark:bg-slate-950/40 rounded-2xl border border-slate-200/50 dark:border-slate-800/40 shadow-2xl backdrop-blur-md overflow-hidden">
            ...
            return (
              ...
              >
                <div className={`flex gap-3 max-w-[80%] ${isUser ? 'flex-row-reverse' : 'flex-row'}`}>
                  {/* Avatar */}
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 border text-xs font-bold ${isUser
                  ...
                  {/* Bubble Content */}
                  <div className={`flex flex-col gap-2 p-4 rounded-2xl text-xs text-left leading-relaxed ${isUser
        ...
        >
          <input
            ...
            className="grow bg-slate-50 dark:bg-slate-900/50 px-4 py-3 text-xs sm:text-sm rounded-xl border border-slate-200 dark:border-slate-800 outline-none focus:border-purple-500 transition-colors"
          />
          <button
            type="submit"
